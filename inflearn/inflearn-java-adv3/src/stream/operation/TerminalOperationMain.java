...
public class TerminalOperationMain {
    public static void main(String[] args) {
        ...
        System.out.println("3. toArray - 배열로 변한");
        Integer[] evenNumbers3 = numbers.stream()
                .filter(n -> n % 2 == 0)
                .toArray(Integer[]::new);
        System.out.println("evenNumbers3 = " + evenNumbers3);
        ...
        System.out.println("5. count - 요소 갯수");
        ...
        Optional<Integer> sum1 = numbers.stream()
                .reduce((a, b) -> a + b);
        System.out.println("합계(초기값없음) = " + sum1.get());
        ...
        System.out.println("9. findAny - 아무 요소나 하나 찾기");
