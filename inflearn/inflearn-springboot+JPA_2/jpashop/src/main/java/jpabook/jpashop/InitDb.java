...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Member member = getMember("userA", "서울", "street1", "111111");
            em.persist(member);
        ...
        private static Member getMember(String username, String city, String street, String zipcode) {
        ...
        public void dbInit2() {
            Member member = getMember("userB", "부산", "street2", "22222");
            em.persist(member);
