...
<body>
    ...
    <div class="collapse show">
        <div class="bg-white p-4">
            <ul class="list-group">
                <a href="/user/register" class="list-group-item list-group-item-action">메시지</a>
    ...
    <%--                    <div class="bg-white p-4">--%>
    <%--                        <ul class="list-group">--%>
    <%--                            <a href="<c:url value='/user/login'/>" class="list-group-item list-group-item-action">로그인</a>--%>
    <%--                            <a href="<c:url value='/user/register'/>" class="list-group-item list-group-item-action">회원가입</a>--%>
    <%--                        </ul>--%>
    <%--                    </div>--%>
    <%--                </div>--%>
            </div>
