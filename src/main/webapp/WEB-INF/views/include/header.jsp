			...
			<div class="nav-item dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
					...
					<s:authorize access="hasRole('ROLE_ADMIN')">
						<li><a class="dropdown-item" href="${contextPath}/jong/admin/usermanage">유저관리</a></li>
						...
						<li><a class="dropdown-item" href="${contextPath}/jong/admin/customerservice">고객센터</a></li>
						<li><hr class="dropdown-divider" /></li>
					</s:authorize>
